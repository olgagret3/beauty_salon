...
function recording(element){
    $.ajax({
        ...
        success: function (data) {
            console.log(data);
            if(data.text === true)
                window.location = `http://express.local/recording`;
            else
                alert(data.text);
        }
    });
...
function exit(){
    ...
    window.location = `http://express.local/`;
}                         
...
function addReview (element){
    $.ajax({
        ...
        success: function (data) {
            if(data.key){
                window.location = `http://express.local/reviews#${data.key}`;
            } else{
                window.location = 'http://express.local/reviews#guest';
            }
        }
    });
    return false;
...
(function(){
    ...
    if(window.location.href === 'http://express.local/#auth'){
        openAuthorization();
    }
})();
